...
//  Zugriffsoperatoren
    ...
    uint32_t getNumNonZeros() const { return _nnz; };
    uint32_t getNumNonZeros(uint32_t i) const { return _IA[i+1]-_IA[i];  }
...
//  Arithmetik
    ...
    void MultiplyRowWithScalar(uint32_t i, double alpha);
